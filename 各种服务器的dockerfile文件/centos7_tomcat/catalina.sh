...
JAVA_OPTS="-server -Xmx1g -Xms1g -Xmn500M -XX:PermSize=500M -XX:MaxPermSize=500M -XX:InitialCodeCacheSize=200M -XX:ReservedCodeCacheSize=200M -Xss256K -XX:+DisableExplicitGC -XX:+UseCodeCacheFlushing -XX:SurvivorRatio=2 -XX:+UseConcMarkSweepGC -XX:+UseParNewGC -XX:+CMSParallelRemarkEnabled -XX:+UseCMSCompactAtFullCollection -XX:CMSFullGCsBeforeCompaction=0 -XX:+CMSClassUnloadingEnabled -XX:LargePageSizeInBytes=128M -XX:+UseFastAccessorMethods -XX:+UseCMSInitiatingOccupancyOnly -XX:CMSInitiatingOccupancyFraction=80 -XX:SoftRefLRUPolicyMSPerMB=0 -XX:+PrintClassHistogram -XX:+PrintGCDetails -XX:+PrintGCTimeStamps -XX:+PrintHeapAtGC -Djava.awt.headless=true -XX:+HeapDumpOnOutOfMemoryError"
